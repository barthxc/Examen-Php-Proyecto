...
<head>
    ...
    include 'bd/bd.php';
    ?>
    <!--Uso el resultado de la cookie para poder agregar la clase sol o ninguna para añadir estilos-->
    ...
    <div class="flex flex-col mb-5 justify-evenly text-gray-400 items-center sm:flex-row">
        <div class="flex flex-row gap-10 py-10 justify-center font-bold text-4xl">
            ...
            <!--Agrego la clase del texto verde cuando existe la sesión usuario -->
        ...
        <div class="flex flex-col gap-2 text-base">
            ...
            <form action="" method="POST">
                <!--Aquí vuelvo a verificar si el usuario está logeado,  -->
                <?php
